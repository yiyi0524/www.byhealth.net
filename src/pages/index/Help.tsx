    ...
    return {
      ...
      list: [
        ...
        },
        {
          ...
          question: "6、如何开方?",
          answer:
            '聊天页面中点击辩证开方, 填写辩病 辩证, 点击编辑药材 选择要开方的药品类型,如果内服中药, 搜索药材名 如 金银花 搜索 "金" "金银" 或"银花" 搜索"金花"不能搜索到, 选中药品之后输入数量,如 500 g,每次开方可选中多个药材, 点击右上角完成, 如果开中药方 需要填写中药的 总剂量 每日剂量 每剂分几次使用, 西药或中成药可以编辑用户用量.  医嘱为选填 诊后管理费可编辑. 点击发送给患者 完成开方',
        },
      ],
    }
  }
