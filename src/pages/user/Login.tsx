...
> {
  ...
  componentDidMount() {
    this.loginStatus = BackHandler.addEventListener('hardwareBackPress', this.addEventListenerLoginStatus)
  }
        ...
        <View style={[style.tabs]}>
          <View style={[style.header, global.flex, global.alignItemsCenter, global.justifyContentSpaceAround]}>
            ...
            >
              <Text
                style={[
                  this.state.selectLoginStyle === 'verificationCodeLogin' ? style.activeTitle : style.title,
                  global.fontSize14,
                ]}
              >
                验证码登录
          ...
          <View style={this.state.selectLoginStyle === 'verificationCodeLogin' ? style.tabItem : global.hidden}>
            ...
            <TouchableOpacity style={style.subBtn} onPress={this.verificationCodeLogin}>
              <Text style={[style.subBtnName, global.fontStyle, global.fontSize18]}>登录医生版</Text>
            </TouchableOpacity>
          </View>
          {/* 密码登录 */}
          <View style={this.state.selectLoginStyle === 'pwdLogin' ? style.tabItem : global.hidden}>
            ...
            <View style={[style.savePwd, global.flex, global.justifyContentSpaceBetween, global.alignItemsCenter]}>
              <TouchableOpacity>
                <Checkbox
