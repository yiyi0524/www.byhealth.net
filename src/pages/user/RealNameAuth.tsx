...
import { Icon, ImagePicker, InputItem, Picker, Portal, TextareaItem, Toast } from '@ant-design/react-native'
...
> {
  ...
  init = async () => {
    try {
      ...
      this.setState({
        ...
        technicalqualificationCertificatePicIdSelectable: technicalqualificationCertificatePicList.length < 10,
  ...
  submit = async () => {
    ...
    let technicalqualificationCertificatePicIds: any = [],
      technicalQualificationCertificatePicIdList = this.state.technicalqualificationCertificatePicList
  ...
  medicalPracticeCertificateChange = async (practisingCertificatePicList: Array<any>, operationType: string) => {
    if (operationType === 'remove') {
      this.setState({
        practisingCertificatePicList,
      })
  ...
  qualificationCertificatePicIdChange = (qualificationCertificatePicList: Array<any>, operationType: string) => {
    if (operationType === 'remove') {
      this.setState({
        qualificationCertificatePicList,
      })
      ...
      <>
        <View style={style.main}>
          <ScrollView style={style.content} keyboardShouldPersistTaps='handled'>
            <View style={style.Theme}>
              <Text style={[style.ThemeTitle, global.fontStyle, global.fontSize16]}>补充审核资料</Text>
            </View>
            ...
            <View style={style.form}>
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                ...
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>
                  请上传
                  <Text style={[style.formImportant, global.fontStyle, global.fontSize14]}>正面照片</Text> ,
                  我们将为您制作漂亮的头像
                </Text>
              </View>
              <View
              ...
              >
                ...
                >
                  ...
                  >
                    <Text style={[style.topItemTitle, global.fontStyle, global.fontSize14]}>
                      {this.state.gender[0] === GENDER.UNDEFINED ? '请选择' : GENDER_ZH[this.state.gender[0]]}
                    </Text>
                    <Icon name='right' style={[style.inputIcon, global.fontSize16]} />
                  </TouchableOpacity>
                </Picker>
            ...
            <View style={style.form}>
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                <Text style={style.formIcon} />
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>科室及擅长</Text>
              </View>
              <View
                style={[
                  style.formItem,
              ...
              >
                ...
                >
                  <Text style={[style.hospitalTitle, global.fontSize14, global.fontStyle]}>请选择 </Text>
                  <Icon name='right' style={[style.inputIcon, global.fontSize16]} />
                </TouchableOpacity>
              </View>
              <View style={[style.adeptSymptomIdList, global.flex, global.flexWrap]}>
                {this.state.adeptSymptomIdList.map((v: any, k: number) => {
                  return (
                    <Text key={k} style={[style.adeptSymptomIdItem, global.fontSize14, global.fontStyle]}>
                      {v.name}
                    </Text>
                  )
                })}
            ...
            <View style={style.Theme}>
              <Text style={[style.ThemeTitle, global.fontStyle, global.fontSize15]}>上传审核证书</Text>
            </View>
            <View style={style.form}>
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                <Text style={style.formIcon} />
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>
                  请上传 <Text style={[style.formImportant, global.fontStyle, global.fontSize14]}> 医师执业证书</Text>
                  (两张)
                </Text>
              </View>
              <View
            ...
            <View style={style.form}>
              ...
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                <Text style={style.formIcon} />
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>
                  请上传 <Text style={[style.formImportant, global.fontStyle, global.fontSize14]}> 医师资格证书</Text>
                  (两张)
                </Text>
              </View>
              <View
            ...
            <View style={style.form}>
              ...
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                ...
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>
                  请上传{' '}
                  <Text style={[style.formImportant, global.fontStyle, global.fontSize14]}> 专业技术资格证书</Text>
                  即职称证书(选填)
                </Text>
              </View>
              ...
              <View style={style.previewPic}>
                ...
                <View style={[global.flex, global.justifyContentSpaceAround, global.alignItemsCenter]}>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({
                  ...
                  >
                    <Image style={style.viewPic} source={gImg.common.technicalqualificationCertificatePicFirst} />
                  </TouchableOpacity>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({
                  ...
                  >
                    <Image style={style.viewPic} source={gImg.common.technicalqualificationCertificatePicSecond} />
                  </TouchableOpacity>
                </View>
              </View>
            </View>
          ...
          <View style={this.state.selectAdeptSymptomActive ? style.adeptSymptom : global.hidden}>
            ...
            >
              <Text style={[style.closeAdeptSymptom, global.fontStyle, global.fontSize14]}>确定并关闭</Text>
            </TouchableOpacity>
            <ScrollView style={style.adeptSymptomContent}>
              <View style={[style.formTitle, global.flex, global.alignItemsCenter]}>
                <Text style={style.formIcon} />
                <Text style={[style.formThem, global.fontStyle, global.fontSize14]}>选择擅长治疗疾病</Text>
              </View>
              {this.state.hospitalDepartmentSymptom.map((v: any, k: number) => {
                return (
                  <View key={k} style={style.symptomList}>
                    <Text style={[style.symptomTitle, global.fontSize14, global.fontStyle]}>{v.name}</Text>
                          ...
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              ...
                              if (adeptSymptomIdList.length < 10000) {
                                hospitalDepartmentSymptom[k].symptomList[k1].isChecked = !v1.isChecked
                                if (v1.isChecked) {
        ...
        <View style={this.state.previewPicFirstActive ? style.picView : global.hidden}>
          ...
          <View style={style.viewImgFather}>
            <Image style={style.viewImg} source={gImg.common.technicalqualificationCertificatePicFirst} />
          </View>
        </View>
        <View style={this.state.previewPicSecondActive ? style.picView : global.hidden}>
          ...
          <View style={style.viewImgFather}>
            <Image style={style.viewImg} source={gImg.common.technicalqualificationCertificatePicSecond} />
          </View>
        </View>
      </>
    )
