    ...
    return (
      <View style={style.tips}>
        <View style={[style.tipsTitlePar, global.flex, global.aCenter, global.jCenter]}>
          <Icon style={style.tipsIcon} name="check-circle" />
          <Text style={style.tipsTitle}>已将整体治疗方案发送给药房</Text>
        </View>
        <Text style={style.tipsDesc}>请提醒患者接听药房电话</Text>
        <Text style={[style.tipsDesc, style.marginBottom]}>博一健康会指导患者完成支付并安排药品配送</Text>
        <DashLine len={45} width={windowWidth - 40} backgroundColor={'rgba(219, 219, 219, 0.4)'} />
      </View>
    )
  }
}
