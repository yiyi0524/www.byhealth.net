...
export async function register({
  uname, pwd, rePwd, registerType, phone = "", phoneVerifyCode = "", email = "",
  emailVerifyCode = "",
}: RegisterParam) {
  return bpost({
    url: '/user/register',
    data: {
      uname, pwd, phone, rePwd, phoneVerifyCode, email,
      emailVerifyCode, registerType,
    },
  })
}
...
export async function userLogin({
  type, account, pwd, accountVerifyCode, rememberAccountPwd,
  email, emailVerifyCode, rememberEmailPwd,
  phone, phoneVerifyCode, rememberPhonePwd
}: LoginParam) {
  switch (type) {
    case LOGIN_TYPE.ACCOUNT_LOGIN:
      if (account !== undefined && pwd !== undefined && accountVerifyCode !== undefined &&
        rememberAccountPwd !== undefined) {
        return userAccountLogin({ account, pwd, accountVerifyCode, rememberPwd: rememberAccountPwd, })
      }
    case LOGIN_TYPE.EMAIL_VERIFY_CODE_LOGIN:
      if (email !== undefined && emailVerifyCode !== undefined && rememberEmailPwd !== undefined) {
        return userEmailLogin({ email, emailVerifyCode, rememberPwd: rememberEmailPwd, })
      }
    case LOGIN_TYPE.PHONE_VERIFY_CODE_LOGIN:
      if (phone !== undefined && phoneVerifyCode !== undefined && rememberPhonePwd !== undefined) {
        return userPhoneLogin({ phone, phoneVerifyCode, rememberPwd: rememberPhonePwd, })
      }
    default:
...
async function userAccountLogin({
  account, pwd, accountVerifyCode, rememberPwd = false,
...
async function userEmailLogin({
  email, emailVerifyCode, rememberPwd,
}: UserEmailLoginParam) {
  return bpost({
    url: 'user/login',
    data: {
...
async function userPhoneLogin({
  phone, phoneVerifyCode, rememberPwd,
}: UserPhoneLoginParam) {
  return bpost({
    url: 'user/login',
    data: {
...
export async function adminLogin({
  ...
  switch (type) {
    case LOGIN_TYPE.ACCOUNT_LOGIN:
      if (account !== undefined && pwd !== undefined && accountVerifyCode !== undefined
        && rememberAccountPwd !== undefined) {
        return adminAccountLogin({ account, pwd, accountVerifyCode, rememberPwd: rememberAccountPwd, })
      }
    case LOGIN_TYPE.EMAIL_VERIFY_CODE_LOGIN:
      if (email !== undefined && emailVerifyCode !== undefined && rememberEmailPwd !== undefined) {
        return adminEmailLogin({ email, emailVerifyCode, rememberPwd: rememberEmailPwd, })
      }
    case LOGIN_TYPE.PHONE_VERIFY_CODE_LOGIN:
      if (phone !== undefined && phoneVerifyCode !== undefined && rememberPhonePwd !== undefined) {
        return adminPhoneLogin({ phone, phoneVerifyCode, rememberPwd: rememberPhonePwd, })
      }
    default:
      return Promise.reject('登录方式不正确');
  }
...
//添加用户
export async function addUser({ account, pwd, rePwd, nick,
  email, phone, isAdmin, profile,
}: AddUserParam) {
  return bpost({
    url: '/addUser',
    data: {
      account, pwd, rePwd, nick,
      email, phone, isAdmin, profile,
    },
  })
}
