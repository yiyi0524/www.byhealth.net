    ...
    private final ReactNativeHost mReactNativeHost = new ReactNativeHost(this) {
        ...
        protected List<ReactPackage> getPackages() {
            return Arrays.asList(new MainReactPackage(),
                    new RNDeviceInfo(), new ImagePickerPackage(), new RNViewShotPackage(),
                    new ReactSliderPackage(), new RNCViewPagerPackage(), new AsyncStoragePackage(),
                    new RNGestureHandlerPackage(), new BuffPackage());
        }
